...
echo -e "${CYAN}============================================${NC}"
echo -e "${GREEN}Evan Container Shell - Quick Start${NC}"
echo -e "${CYAN}============================================${NC}"
echo
...
if ! docker images | grep -q "claude-agent"; then
    ...
    cd evan/tools/linux_desktop_environment/scripts
...
case $choice in
    ...
    4)
        ...
        python -c "
from evan.container_shell import ContainerShell
