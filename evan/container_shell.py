#!/usr/bin/env python3
"""
Interactive Container Shell for Evan Linux Environment
...
class ContainerShell:
    ...
    def create_container(self, conversation_id: Optional[str] = None) -> str:
        ...
        try:
            ...
            print(f"Run: cd evan/tools/linux_desktop_environment/scripts && ./build-agent-image.sh")
            sys.exit(1)
...
@click.group()
def cli():
    """Container Shell - Interactive interface for Evan containers."""
    pass
