...
mkdir -p evan_runtime/agent-working-directory
...
echo "     --read-only \\"
echo "     -v ./evan_runtime/agent-working-directory/my-agent:/mnt \\"
echo "     $FULL_IMAGE"
echo ""
